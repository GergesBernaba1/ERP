<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-BackSales.aspx.cs" Inherits="Add_BackSales" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">فاتورة مرتجع مبيعات</h2>
                    </div>
                    <div class="container-fluid">
                                ...
                                <div id="Div1" dir="rtl" runat="server" style="height: 200px; width: 100%; left: 5%; right: 5%; margin: 2em auto; overflow-x: scroll; overflow-y: scroll">
                                    <table id="tabelLoad" style="width: 100%; border: solid">
                                        <tr style="background-color: #7ba4e5; color: #fff; height: 35px; font-size: 20px; font-weight: bold">
                                            <td style="width:22%">الباركود</td>
                                            <td style="width:22%">اسم الصنف</td>
                                            <td style="width:8%">الكمية</td>
                                            <td style="width:20%;font-size:17px">تاريخ الصلاحية</td>
                                            <td style="width:8%;font-size:17px">سعر الشراء</td>
                                        ...
                                        <tr style="background-color:#dbd9d9;font-size:20px;border-style:solid">
                                            <td style="width:22%"><%=dt.Rows[i]["BarCode"].ToString() %></td>
                                            <td style="width:22%"><%=dt.Rows[i]["Name"].ToString() %></td>
                                            ...
                                            <td style="width:8%"><%=dt.Rows[i]["Price"].ToString() %></td>

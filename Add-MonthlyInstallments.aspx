<%@ Page Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-MonthlyInstallments.aspx.cs" Inherits="Add_MonthlyInstallments" %>
    ...
    <section class="add-InsMent clearfix">
        <div class="container-fluid">
            ...
            <div class="col-md-0 col-xs-18">
               ...
               <div class="item-info">
                    <label>النوع</label>
                    <asp:DropDownList ID="drpType" CssClass="form-control mid-screen-b  xs-screen-b " runat="server"  onchange="changeborderColorafterfill(this)" AutoPostBack="true" ValidationGroup="1" OnSelectedIndexChanged="drpType_SelectedIndexChanged" TabIndex="2" ></asp:DropDownList>  
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="اختار" ControlToValidate="drpType" ErrorMessage="" ValidationGroup="1"></asp:RequiredFieldValidator>
                </div>
                <div class="item-info">
                    <label>الاسم</label>
                    <asp:DropDownList ID="drpName" CssClass="form-control mid-screen-b  xs-screen-b" runat="server"  onchange="changeborderColorafterfill(this)" ValidationGroup="1" TabIndex="3" ></asp:DropDownList>  
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" InitialValue="اختر الاسم" ControlToValidate="drpName" ErrorMessage="" ValidationGroup="1"></asp:RequiredFieldValidator>
                <asp:RadioButtonList ID="Radio" CssClass="inline-div" RepeatDirection="Horizontal" runat="server">
                                                <asp:ListItem Selected="True" Value="دفع"></asp:ListItem>
                                                <asp:ListItem Value="استلام"></asp:ListItem>
                                            </asp:RadioButtonList>
                </div>
            ...
            <hr /> 
                    <div class="item-info">
                        <label>المبلغ</label>
                        <asp:TextBox ID="txtAmount" CssClass=" form-control mid-screen-b  xs-screen-b" runat="server" AutoPostBack="true"  onchange="changeborderColorafterfill(this)" ValidationGroup="1" TabIndex="4"></asp:TextBox>  
                    ...
                    <div class="item-info">
                        ...
                        <asp:Button ID="btnPuplish" CssClass="btn" runat="server" style="background-color:grey" Text="توزيع الاقساط" OnClick="btnPuplish_Click" TabIndex="9"  />
                    </div>
            ...
            <div class="submit-rev-add">
                            <asp:Button ID="btnSave" CssClass="btn" runat="server" Enabled="false" Text="حفظ / Save"  ValidationGroup="1" OnClientClick="customValidations('1')" OnClick="btnSave_Click" />

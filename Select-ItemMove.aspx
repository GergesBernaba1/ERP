<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select-ItemMove.aspx.cs" Inherits="Select_ItemMove" %>
            ...
            <section class="add-custgrp clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">مراجعة تحويلات المخازن</h2>
                    </div>
                    <div class="item-info">

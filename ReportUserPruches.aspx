<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="ReportUserPruches.aspx.cs" Inherits="ReportUserPruches" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">تقرير المشتريات للمستخدم</h2>
                    </div>
            </section>
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="ReportUserPruches.rpt"></Report>

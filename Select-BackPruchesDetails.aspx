<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select-BackPruchesDetails.aspx.cs" Inherits="Select_BackPruchesDetails" %>
            ...
            <section class="add-custgrp clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">مراجعة اصناف فاتورة مرتجع المشتريات</h2>
                    </div>

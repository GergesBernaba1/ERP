<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-Order.aspx.cs" Inherits="Add_Order" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">اضافة طلبية مشتريات</h2>
                    </div>
                    <div class="container-fluid">
                                    ...
                                    <table id="tabelLoad" style="width: 100%; border: solid">
                                        <thead>
                                            ...
                                            <tr style="border-style:solid">
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="LinkAdd"  ValidationGroup="3" OnClientClick="getItems()" runat="server" OnClick="LinkAdd_Click">اضافة</asp:LinkButton>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody id="bodytable">

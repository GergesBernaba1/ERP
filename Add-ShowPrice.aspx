<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-ShowPrice.aspx.cs" Inherits="Add_ShowPrice" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">عرض اسعار</h2>
                    </div>
                    <div class="container-fluid">
                        <div class=" mainfix clearfix">
                            <div class="item-info">
                                ...
                                <label class="laborder">اسم العرض</label>
                                <asp:TextBox ID="txtName" CssClass="form-control mid-screen xs-screen" AutoPostBack="true" runat="server" onchange="changeborderColorafterfill(this)" ValidationGroup="1" OnSelectedIndexChanged="drpStore_SelectedIndexChanged"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"  ControlToValidate="txtName" ErrorMessage="" ValidationGroup="1"></asp:RequiredFieldValidator>
                            </div>
                            <div class="item-info">
                                ...
                                <div id="Div1" dir="rtl" runat="server" style="height: 200px; width: 100%; left: 5%; right: 5%; margin: 2em auto; overflow-x: scroll; overflow-y: scroll">
                                    <table id="tabelLoad" style="width: 100%; border: solid">
                                        ...
                                        <tr style="background-color:#dbd9d9;font-size:20px;border-style:solid">
                                            ...
                                            <td><%=float.Parse(dt.Rows[i]["Price"].ToString())*float.Parse(dt.Rows[i]["Num"].ToString()) %></td>
                            ...
                            <div class="item-info">
                                ...
                                <asp:TextBox ID="txtAdd" Style="width: 150px" runat="server" Text="0" AutoPostBack="true" onchange="changeborderColorafterfill(this)" ValidationGroup="1" OnTextChanged="txtAdd_TextChanged"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtDiscount" Style="width: 150px" Text="0" runat="server" AutoPostBack="true" onchange="changeborderColorafterfill(this)" ValidationGroup="1" OnTextChanged="txtDiscount_TextChanged"></asp:TextBox>

...
public partial class ReportItems : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                string sql1 = @"select * from Application_Setting where User_Id=" + Session["Id"] + " and Appl_Id=57 and IsVaild=1";
                ...
                if (dt1.Rows.Count == 1)
                {
                    ...
                    reportdocument.Load(Server.MapPath("Reports/ReportItems.rpt"));

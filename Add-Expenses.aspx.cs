...
public partial class Add_Expenses : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                string sql1 = @"select * from Application_Setting where User_Id=" + Session["Id"] + " and Appl_Id=48 and IsVaild=1";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            string Expense = @"INSERT INTO [dbo].[Expenses] ([Code],[Name],[DateOfExpenses],[Amount],[User_Id],[Notes]) VALUES(@1,@2,@3,@4,@5,@6)";
            ...
            databaseaccesslayerobj.Execute(treasure, TxtCode.Text, (-1 * float.Parse(txtAmount.Text)), "مصروفات", DateTime.Now, Session["Id"]);

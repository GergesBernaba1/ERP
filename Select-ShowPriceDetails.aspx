<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select-ShowPriceDetails.aspx.cs" Inherits="Select_ShowPriceDetails" %>
            ...
            <section class="add-custgrp clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">مراجعة اصناف عروض الاسعار</h2>
                    </div>

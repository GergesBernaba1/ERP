...
using System.Web.Script.Serialization;
    public class databaseaccesslayer
    {
        ...
        /// </summary>
        //public static string ERPConnectionString = @"Server=142.4.219.154\SQLEXP2016;Database=antoneid_ERPSystem;uid=antoneid;pwd=Anton12345"; //
        public static string ERPConnectionString = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=ERPsystem;Data Source=."; //
       /// <summary>
       /// create connection
       /// </summary>
       /// <returns></returns>

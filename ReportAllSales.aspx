<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="ReportAllSales.aspx.cs" Inherits="ReportAllSales" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">تقرير فواتير المبيعات</h2>
                    </div>
                    <div class="row">
                        ...
                        <div runat="server" id="div"   visible="false" class="title-hav clearfix">
                            ...
                            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                <Report FileName="ReportSales"></Report>

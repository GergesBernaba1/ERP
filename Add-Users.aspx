<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-Users.aspx.cs" Inherits="Add_Users" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">اضافة مستخدم جديد</h2>
                    </div>
                                ...
                                <div class="main-info clearfix">
                                    <div class="col-md-9 col-xs-12">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <asp:TextBox ID="txtPassword" TextMode="Password" CssClass="form-control mid-screen xs-screen" runat="server" onchange="changeborderColorafterfill(this)" ValidationGroup="1"></asp:TextBox>
                                        ...
                                        <div class="item-info">
                                            ...
                                            <asp:TextBox ID="txtMobil" CssClass="form-control mid-screen xs-screen" runat="server" onchange="changeborderColorafterfill(this)" ValidationGroup="2"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMobil" ValidationGroup="2" ErrorMessage=""></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-xs-12 non-padding">
                                            ...
                                            <asp:TextBox ID="txtAddress" CssClass="form-control mid-screen xs-screen" runat="server" onchange="changeborderColorafterfill(this)" ValidationGroup="2"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtAddress" ValidationGroup="2" ErrorMessage=""></asp:RequiredFieldValidator>

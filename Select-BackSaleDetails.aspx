<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select-BackSaleDetails.aspx.cs" Inherits="Select_BackSaleDetails" %>
            ...
            <section class="add-custgrp clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">مراجعة اصناف فاتورة مرتجع المبيعات</h2>
                    </div>

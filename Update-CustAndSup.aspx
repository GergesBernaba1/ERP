<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Update-CustAndSup.aspx.cs" Inherits="Update_Customer" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">تعديل العملاء والموردين</h2>
                    </div>
                                        ...
                                        <div class="item-info">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMoney" ValidationGroup="1" ErrorMessage=""></asp:RequiredFieldValidator>
                                              <asp:RadioButtonList ID="RadioCustomer" CssClass="inline-div" RepeatDirection="Horizontal" runat="server">
                                                <asp:ListItem Selected="True" Value="مدين"></asp:ListItem>
                                                <asp:ListItem Value="دائن"></asp:ListItem>
                                            </asp:RadioButtonList>

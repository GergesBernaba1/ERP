...
public partial class ReportAllSales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                string sql1 = @"select * from Application_Setting where User_Id=" + Session["Id"] + " and Appl_Id=63 and IsVaild=1";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            div.Visible = true;
            string sql = @"AllSales '" + DateTime.Parse(txtDateFrom.Text) + "','" + DateTime.Parse(txtDateTo.Text) + "'";
            System.Drawing.Printing.PrintDocument printDocument = new System.Drawing.Printing.PrintDocument();
            ReportDocument reportdocument = new ReportDocument();
            reportdocument.Load(Server.MapPath("Reports/ReportSales.rpt"));

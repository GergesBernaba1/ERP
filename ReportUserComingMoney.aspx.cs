...
public partial class ReportUserComingMoney : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dt1.Rows.Count == 1)
            {
                string sql = @"UserComingMoney " + Session["UserReportId"] + ",'" + DateTime.Parse(Session["DateFrom"].ToString()) + "','" + DateTime.Parse(Session["DateTo"].ToString()) + "'";
                string path = "Reports/ReportUserComeMoney.rpt";

<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Add-ReciveMoney.aspx.cs" Inherits="Add_ReciveMoney" %>
            ...
            <section class="tabs-cus-Sup clearfix">
                ...
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">استلام نقدية</h2>
                    </div>
                    <div class="row">

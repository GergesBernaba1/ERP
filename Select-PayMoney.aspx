<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterAR.master" AutoEventWireup="true" CodeFile="Select-PayMoney.aspx.cs" Inherits="Select_PayMoney" %>
            ...
            <section class="add-custgrp clearfix">
                <div class="container-fluid">
                    <div class="title-hav clearfix">
                        <h2 class="title fix-bg">مراجعة ايصالات دفع نقدية</h2>
                    </div>
                    <div class="item-info">
